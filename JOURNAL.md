...
**Open questions.** Will the 3 proposed entries (ROP, V, MSFT) fill at limit, or run away pre-market? What's the one thing that could derail the 62% confidence target? Any overnight news on these names worth checking before placing orders? 
